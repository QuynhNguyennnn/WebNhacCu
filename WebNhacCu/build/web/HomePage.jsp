    ...
    <body class="main-layout">
        ...
        <div class="header_section">
            <jsp:include page="Header.jsp"></jsp:include>
                <div class="banner_section pos">
                    <div class="container-fluid ">
                        <section class="slide-wrapper ">
                            <div class="container-flui" style="padding-top: 90px;">
            ...
            <div class="container ">
                ...
                <div class="collection_section_2 ">
                    <div class="row ">
                        ...
                        <div class="col-md-6 ">
                            <div class="about-img2 " style="margin-top: 0.5px;">
                                <div style="height: 532px;" class="shoes-img2 "><img class="guitar_img " src="${lastDrum.image}"></div>
