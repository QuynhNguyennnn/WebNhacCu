                ...
                <div class="basket">
                    <c:if test="${sessionScope.acc.isStaff == 1 || sessionScope.acc.isAdmin == 1}">
                        <div class="basket-module">
                            <form action="LoadInfo">
                            <input placeholder="Enter a customer phone" name="phone" type="text" name="promo-code" class="promo-code-field">
                            <button class="promo-code-cta" type="submit">Apply</button>
                            </form>
                        </div>
                    </c:if>
            ...
            <aside>
                ...
                <c:if test="${sessionScope.acc.isStaff == 1 || sessionScope.acc.isAdmin == 1}">
                    ...
                    <div class="summary-checkout">
                        <c:if test="${sessionScope.acc.isCus == 1}">
                            <a href="Pay?total=${Discount}" class="checkout-cta">
                                Pay
                            </a>
                        </c:if>
                        <c:if test="${sessionScope.acc.isStaff == 1 || sessionScope.acc.isAdmin == 1}">
                            <a href="Pay?total=${Discount1}&phone=${Phone}" class="checkout-cta">
                                Pay
                            </a>
                        </c:if>
                    </div>
